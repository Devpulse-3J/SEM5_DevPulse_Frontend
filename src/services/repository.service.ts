...
const MOCK_REPOSITORIES: Repository[] = [
  {
    ...
    name: "auth-service",
    owner: "DevPulseOrg",
    fullName: "DevPulseOrg/auth-service",
    description: "OAuth2 & JWT authentication microservice gateway",
    url: "https://github.com/DevPulseOrg/auth-service",
    defaultBranch: "main",
    language: "TypeScript",
    isPrivate: true,
    status: "active",
  ...
  },
  {
    ...
    owner: "DevPulseOrg",
    fullName: "DevPulseOrg/metrics-pipeline",
    description: "High-throughput telemetry ingestion & DORA calculator engine",
    url: "https://github.com/DevPulseOrg/metrics-pipeline",
    defaultBranch: "main",
    language: "Go",
    isPrivate: true,
    status: "active",
  ...
  },
  {
    ...
    owner: "DevPulseOrg",
    fullName: "DevPulseOrg/dashboard-frontend",
    description: "Next.js 15 analytics & productivity client application",
    url: "https://github.com/DevPulseOrg/dashboard-frontend",
    defaultBranch: "main",
    language: "TypeScript",
    isPrivate: true,
    status: "active",
