    ...
    <div className="flex max-w-4xl flex-col gap-6">
      <div>
        <h1 className="mb-0.5 text-xl font-bold text-ink flex items-center gap-2">
          <FaJira className="h-5 w-5 text-blue-400" /> Jira Integration &amp; Webhook Module
        </h1>
        <p className="text-xs text-subtle">
          Authorize Jira Cloud via Atlassian 3-LO OAuth 2.0 or manually configure webhooks and secret validation.
        </p>
      </div>

      {/* 1-Click Atlassian OAuth Section */}
      ...
      {/* Manual Copyable Webhook URL Display */}
      <div className="flex flex-col gap-3 rounded-panel border border-border bg-surface p-5">
        <div>
          <h2 className="text-sm font-semibold text-ink">Manual Webhook Endpoint URL</h2>
          <p className="mt-1 text-xs text-subtle">
            Paste this URL into your Jira Webhook configuration settings under System → Webhooks if not using 1-Click OAuth.
          </p>
        </div>
