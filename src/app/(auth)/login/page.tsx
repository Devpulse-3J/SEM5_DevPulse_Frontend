  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <h1 className="text-xl font-bold mb-1">Sign in to your workspace</h1>
      ...
      <div className="bg-surface border border-border rounded-panel p-7 flex flex-col gap-4 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.6)]">
        ...
        <form className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="w-full h-10 mt-1 rounded-lg bg-accent text-canvas font-bold text-xs hover:brightness-110 transition-all cursor-pointer border-none"
          >
            Sign In
          </button>
        </form>
